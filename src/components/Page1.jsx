        ...
        <div className="grid">
          <ul className="items">
            ...
            <li className="item item-1-1">
              < Link to={`/mens_outerwear/details/img1_1`} state={{ from: "occupation" }} id="img1_1" className="item-link-to-dscrp" >
            ...
            <li className="item item-1-2">
              <Link to={`/mens_outerwear/details/img1_2`}  state={{ from: "occupation" }} id="img1_2" className="item-link-to-dscrp">
            ...
            <li className="item item-1-3">
              <Link to={`/mens_outerwear/details/img1_3`}  state={{ from: "occupation" }} id="img1_3" className="item-link-to-dscrp">
            ...
            <li className="item item-1-4">
              <Link to={`/mens_outerwear/details/img1_4`}  state={{ from: "occupation" }} id="img1_4" className="item-link-to-dscrp">
            ...
            <li className="item item-1-5">
              <Link to={`/mens_outerwear/details/img1_5`}  state={{ from: "occupation" }} id="img1_5" className="item-link-to-dscrp">
            ...
            <li className="item item-1-6">
              <Link to={`/mens_outerwear/details/img1_6`} state={{ from: "occupation" }} id="img1_6" className="item-link-to-dscrp">
            ...
            <li className="item item-1-7">
              <Link to={`/mens_outerwear/details/img1_7`} state={{ from: "occupation" }} id="img1_7" className="item-link-to-dscrp">
            ...
            <li className="item item-1-8">
              <Link to={`/mens_outerwear/details/img1_8`} state={{ from: "occupation" }} id="img1_8" className="item-link-to-dscrp" >
            ...
            <li className="item item-1-9">
              <Link to={`/mens_outerwear/details/img1_9`} state={{ from: "occupation" }} id="img1_9" className="item-link-to-dscrp">
            ...
            <li className="item item-1-10">
              <Link to={`/mens_outerwear/details/img1_0`} state={{ from: "occupation" }} id="img1_0" className="item-link-to-dscrp" >
